            ...
            steps {
                script {
                    ...
                    withCredentials([usernamePassword(credentialsId: 'artifactory-passwd', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD')]) {
                        sh "curl -u ${USERNAME}:${PASSWORD} -X put https://artifactory.webtree.org/artifactory/list/dev/org/webtree/auth-core/${version}/ -T core/target/auth-core-${version}.jar"
                    }
                }
            }
        }
